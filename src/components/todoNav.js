...
class MainNav extends Component {
    ...
    async handleShowCompletedItems(){
        ...
        try {
            ...
            let response = await fetch('http://localhost:5000/api/showCompleted',{
                    method:'POST',
                    headers:{
                        'Accept': 'application/json',
                        'Content-Type':'application/json'
    ...
    async handleShowStarItems(){
        ...
        try {
            ...
            let response = await fetch('http://localhost:5000/api/showUrgent',{
                    method:'POST',
                    headers:{
                        'Accept': 'application/json',
                        'Content-Type':'application/json'
    ...
    async handleShowCustomizedTodoItem(listID){
        try {
            ...
            let response = await fetch('http://localhost:5000/api/showCustomizedItem',{
                    method:'POST',
                    headers:{
                        'Accept': 'application/json',
                        'Content-Type':'application/json'
    ...
    async deleteTodoList(id){
        ...
        try {
            ...
            let response = await fetch('http://localhost:5000/api/removeCollection',{
                    method:'POST',
                    headers:{
                        'Accept': 'application/json',
                        'Content-Type':'application/json'
