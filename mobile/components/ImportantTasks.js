...
import EditImportantTask from '../components/EditImportant';
...
class ImportantTaskList extends Component {
                ...
                <View style={{ flex: 1.3, backgroundColor: "#96CAF7" , paddingBottom:75}}>
                   <View style={{marginTop:40}}>
                        <SafeAreaView>
                            ...
                            <EditImportantTask taskName={list.Name} taskDate={list.Deadline} taskID={list._id} handleShowStarItems={this.handleShowStarItems}> </EditImportantTask>
    ...
    async handleShowStarItems(){
        ...
        try {
            ...
            let response = await fetch('http://s21l-g25.herokuapp.com/api/showUrgent',{
                    method:'POST',
                    headers:{
                        'Accept': 'application/json',
                        'Content-Type':'application/json'
